...
class Admin extends CI_Controller {
	...
	public function entry_gate()
	{
		...
		else
		{
			...
			$this->load->view('super_admin/index', $dash_data);
		}
	}
	...
	public function adhoc_edit($trans=false)
	{
		...
		else
		{
			...
			$this->load->view('super_admin/reg_adhoc', $dash_data);
		}
			
	}

	public function staff_edit($trans=false)
	{
		if(empty($_SESSION['result_gate_pass']) || empty($_SESSION['result_gate_pass_time'])  || ((time() - $_SESSION['result_gate_pass_time']) > 1800) || ($_SESSION['result_gate_user_type'] != 2))
		{
			$_POST['Username'] = $_POST['password'] = '';
		...
		else
		{
			...
			$this->load->view('super_admin/reg_staff', $dash_data);
		}
			
	}

	public function center_edit($trans=false)
	{
		if(empty($_SESSION['result_gate_pass']) || empty($_SESSION['result_gate_pass_time'])  || ((time() - $_SESSION['result_gate_pass_time']) > 1800) || ($_SESSION['result_gate_user_type'] != 2))
		{
			$_POST['Username'] = $_POST['password'] = '';
		...
		else
		{
			...
			$this->load->view('super_admin/reg_center', $dash_data);
		}
	...
	public function trainee_stat($trans=false)
	{
		...
		else
		{
			...
			$this->load->view('super_admin/trainee_stat', $dash_data);
		}
	...
	public function adhoc_stat($trans=false)
	{
		...
		else
		{
			...
			$this->load->view('super_admin/adhoc_stat', $dash_data);
		}
	...
	public function adhoc_profile($trans=1)
	{
		...
		else
		{
			...
			$this->load->view('super_admin/adhoc_profile', $dash_data);
		}
			
	}

	public function post_enroll($trans=false)
	{
		//var_dump($_POST['data']);
		/*var_dump($_POST);
		var_dump($_FILES);
