$(function(){        
    ...
    var jvm_wm = new jvm.WorldMap({container: $('#dashboard-map-seles'),
                                    ...
                                    //markers: mymarker_val
                                    markers: [{latLng: [10.3232, 4.1514], name: 'Niger - 1'},                                              
                                              {latLng: [9.2446, 9.3673], name: 'Plateau - 2'},
                                              {latLng: [11.7574, 8.6601], name: 'Kano - 1'},                                            
                                              {latLng: [9.0765, 7.3986], name: 'Abuja - 3'},                                                                                                      
                                              {latLng: [6.5244, 3.3792], name: 'Lagos - 5'},
                                              {latLng: [35.38, 139.69], name: 'Tokyo - 12'},
                                              {latLng: [37.78, -122.41], name: 'San Francisco - 8'},
                                              {latLng: [28.61, 77.20], name: 'New Delhi - 4'},
                                              {latLng: [39.91, 116.39], name: 'Beijing - 3'}]
