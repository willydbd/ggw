<ul class="x-navigation x-navigation-horizontal x-navigation-panel">
    ...
    <li>
        <?php 
            ...
            if(!empty($_SESSION['result_gate_CENTER_NAME']))
            {
                echo '<h3 style="line-height: 2.8; color: #fff;">'.strtoupper($_SESSION["result_gate_CENTER_NAME"]).'</h3>';
            }
            else
                echo '<a href="#" onclick="initiate_system()" class="btn btn-danger">Initiate System for Use</a>';
