        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Registered Observers</li>
                </ul>
                <!-- END BREADCRUMB --> 
                
                <!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2><a href="<?php echo base_url(); ?>Admin/entry_gate"><span class="fa fa-arrow-circle-o-left"></span></a> REGISTERED OBSERVERS</h2>
                </div>
                <!-- END PAGE TITLE -->                
                            ...
                            <div class="panel panel-success">
                                <div class="panel-heading">
                                    ...
                                    <div class="btn-group pull-right">
                                        ...
                                        <a class="btn btn-success" href="<?php echo base_url().'Admin/staff_edit/'; ?>"><i class="glyphicon glyphicon-plus"></i> Add Observer</a>
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    if(!empty($staff_info_data) && is_array($staff_info_data))
                                                    {
                                                        ...
                                                        foreach ($staff_info_data as $key => $trld_val) 
                                                        {
                                                            $count++;
                                                            $trid = $trld_val['id'];
                                                            ...
                                                            $center_name_ID = $trld_val['center_name_ID'];
                                                            $center_name_str = '';
                                                            ...
                                                            $tbb .= '<tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <a href="'.base_url().'Admin/staff_edit/'.$trid.'" class="btn-sm btn-danger">
