        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> TRAINEE PROFILE</h2>
                ...
                <div class="page-content-wrap">                
                    ...
                    <?php
                        if(!empty($trainee_location_data) && is_array($trainee_location_data))
                        {
                            ...
                            $photopath = base_url().'gsi-assets/image_uploads/trainee_center_id/'.$photo;
                            //var_dump($photopath);
                                        ...
                                        <div class="panel panel-default" style="border: none;box-shadow: none;">
                                            <div class="panel-body">
                                                ...
                                                <div id="company_name" style="margin-top: 5px;">
                                                    ...
                                                    <h3 class="text-center" style="font-size: 15px;">ANAMBRA SKILL ACQUISITION CENTRE</h3>                                                   
                                                </div>
                                            ...
                                            <div class="panel-body form-group-separated">
                                                <form action="#" class="form-horizontal">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-5 control-label">Annual Income</label>
                                                        <div class="col-md-7">
