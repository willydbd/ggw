...
<head>        
        ...
        <title>National Agency for the Great Green Wall - List of center_names</title>         
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Registered Center</li>
                </ul>
                <!-- END BREADCRUMB --> 
                
                <!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2><a href="<?php echo base_url(); ?>Admin/entry_gate"><span class="fa fa-arrow-circle-o-left"></span></a> REGISTERED CENTER</h2>
                </div>
                <!-- END PAGE TITLE -->                
                            ...
                            <div class="panel panel-success">
                                <div class="panel-heading">
                                    ...
                                    <div class="btn-group pull-right">
                                        ...
                                        <a class="btn btn-success" href="<?php echo base_url().'Admin/center_edit/'; ?>"><i class="glyphicon glyphicon-plus"></i> Add Site Center</a>
                                        ...
                                        <table id="customers2" class="table table-striped datatable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 200px;">Center Name</th>
                                                    <th>Project</th>
                                                    <th>State</th>
                                                    <th>L.G.A</th>
                                                        ...
                                                        foreach ($basic_site_info_data as $key => $trld_val) 
                                                        {
                                                            ...
                                                            $tbb .= '<tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <a href="'.base_url().'Admin/center_edit/'.$trid.'" class="btn-sm btn-danger">
