        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    <h2><a href="<?php echo base_url(); ?>Admin/adhoc_list"><span class="fa fa-arrow-circle-o-left"></span></a> Adhoc Staff Registration</h2>
                </div>
                <!-- END PAGE TITLE -->                
                      ...
                      if(data != undefined)
                      {
                        if(data.length > 0)
                        {
                            ...
                            if(data == '1')
                            {
                                ...
                                var redir = "<?php echo base_url() ?>"+'Admin/adhoc_list/';
