        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Center Information</li>
                </ul>
                <!-- END BREADCRUMB --> 
                
                <!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2><a href="<?php echo base_url(); ?>Trainee/entry_gate"><span class="fa fa-arrow-circle-o-left"></span></a> Center Information</h2>
                </div>
                <!-- END PAGE TITLE -->                
                                        ...
                                        <div class="row" style="line-height: 3; margin-top: 40px;">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">                
                                                    ...
                                                    <div style="margin-top: 0px;">
                                                        <code> Easting </code>
                                                        <input type="text" class="form-control" id="easting" placeholder="Easting" value="<?php echo $easting ?>" />
                                                    </div>
                                                    <div style="margin-top: 0px;">
                                                        <code> Northing</code>
                                                        <input type="text" class="form-control" id="northing" placeholder="Northing" value="<?php echo $northing ?>"/>
                                                    </div>
                                        ...
                                        <div class="row" style="line-height: 3; margin-top: 40px;">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <div style="margin-top: 0px;">
                                                        <code> Colour </code>
                                                        <input type="text" class="form-control" id="colour" placeholder="Colour" value="<?php echo $colour ?>"/>
                                                    </div>
