        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    <h2><a href="<?php echo base_url(); ?>Trainee/entry_gate"><span class="fa fa-arrow-circle-o-left"></span></a> REGISTERED ADHOC STAFF</h2>
                </div>
                <!-- END PAGE TITLE -->                
                                                        ...
                                                        foreach ($adhoc_basic_info_data as $key => $trld_val) 
                                                        {
                                                            ...
                                                            $tbb .= '<tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <a href="'.base_url().'Trainee/adhoc_edit/'.$trid.'" class="btn-sm btn-danger">
                                                                                <i class="glyphicon glyphicon-edit"></i>
                                                                            </a>

                                                                            <a href="'.base_url().'Trainee/adhoc_profile/'.$trid.'" class="btn-sm btn-primary">
